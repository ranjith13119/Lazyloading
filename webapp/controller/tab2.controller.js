sap.ui.define([
	...
	return Controller.extend("iconT.IconT.controller.tab2", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf iconT.IconT.view.tab2
		 */
		onInit: function () {
			this.oTable = this.getView().byId("idProductsTabldd");
			this.LocalData();
			var oModel = new JSONModel();
			oModel.setData(this.data);
			this.getView().setModel(oModel);
			this.mGroupFunctions = {
				tab31: function (oContext) {
					var name = oContext.getProperty("MainCategory");
					return {
						key: name,
						text: "Grouped By MainCategory- " + name
					};
				},
				tab32: function (oContext) {
					var name = oContext.getProperty("Category");
					return {
						key: name,
						text: "Grouped By Category- " + name
					};
				},
				tab33: function (oContext) {
					var name = oContext.getProperty("SupplierName");
					return {
						key: name,
						text: "Grouped By SupplierName- " + name
					};
				}
			};
			var that = this;
		...
		onGroupSelect: function (oEvent) {
			var oBinding = this.oTable.getBinding("items"),
				...
				vGroup,
				aGroups = [],
				sKey = oEvent ? oEvent.getParameter("key") : "tab31";
		...
		LocalData: function () {
				this.data = {
					"ProductCollection": [{
						...
						"Height": 3,
						"DimUnit": "cm",
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/"
					}, {
						"ProductId": "HT-1001",
						"Category": "Laptops",
						"MainCategory": "Computer Systems",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1022.jpg",
						"Status": "Available",
						"Quantity": 30,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1031.jpg",
						"Status": "Available",
						"Quantity": 24,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1032.jpg",
						"Status": "Available",
						"Quantity": 50,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1036.jpg",
						"Status": "Available",
						"Quantity": 22,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Flat XL",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1037.jpg",
						"Status": "Available",
						"Quantity": 23,
						"UoM": "PC",
						"CreatedAt": "/Date(1571677519944)/",
						...
						"Name": "Laser Allround",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1042.jpg",
						"Status": "Available",
						"Quantity": 9,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1050.jpg",
						"Status": "Available",
						"Quantity": 17,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Multi Color",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1056.jpg",
						"Status": "Available",
						"Quantity": 5,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Cordless Mouse",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1060.jpg",
						"Status": "Available",
						"Quantity": 25,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Speed Mouse",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1061.jpg",
						"Status": "Available",
						"Quantity": 12,
						"UoM": "PC",
						"CreatedAt": "/Date(1571677519944)/",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1063.jpg",
						"Status": "Available",
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						"Quantity": 50,
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1064.jpg",
						"Status": "Available",
						"Quantity": 35,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Mousepad",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1066.jpg",
						"Status": "Available",
						"Quantity": 12,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Ergo Mousepad",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1067.jpg",
						"Status": "Available",
						"Quantity": 16,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1068.jpg",
						"Status": "Available",
						"Quantity": 26,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1069.jpg",
						"Status": "Available",
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						"Quantity": 22,
						...
						"Name": "Proctra X",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1070.jpg",
						"Status": "Available",
						"Quantity": 15,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Hurricane GX",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1072.jpg",
						"Status": "Available",
						"Quantity": 13,
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1073.jpg",
						"Status": "Available",
						"Quantity": 5,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Photo Scan",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1080.jpg",
						"Status": "Available",
						"Quantity": 8,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Power Scan",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1081.jpg",
						"Status": "Available",
						"Quantity": 11,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1082.jpg",
						"Status": "Available",
						"Quantity": 13,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Jet Scan Professional",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1083.jpg",
						"Status": "Available",
						"Quantity": 10,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Copymaster",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1085.jpg",
						"Status": "Available",
						"Quantity": 10,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Surround Sound",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1090.jpg",
						"Status": "Available",
						"Quantity": 20,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1091.jpg",
						"Status": "Available",
						"Quantity": 15,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Sound Booster",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1092.jpg",
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						"Quantity": 50,
						"UoM": "PC",
						...
						"Name": "Smart Office",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1100.jpg",
						"Status": "Available",
						"Quantity": 25,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Smart Design",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1101.jpg",
						"Status": "Available",
						"Quantity": 26,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Smart Network",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1102.jpg",
						"Status": "Available",
						"Quantity": 28,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1103.jpg",
						"Status": "Available",
						"CreatedAt": "/Date(1571677519944)/",
						"ChangedAt": "/Date(1571677519944)/",
						"Quantity": 9,
						...
						"Name": "Smart Games",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1104.jpg",
						"Status": "Available",
						"Quantity": 13,
						"UoM": "PC",
						"CreatedAt": "/Date(1571677519944)/",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1105.jpg",
						"Status": "Available",
						"Quantity": 17,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Smart Firewall",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1106.jpg",
						"Status": "Available",
						"Quantity": 19,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Smart Money",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1107.jpg",
						"Status": "Available",
						"Quantity": 18,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "PC Lock",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1110.jpg",
						"Status": "Available",
						"Quantity": 14,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Copperberry",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-7000.jpg",
						"Status": "Available",
						"Quantity": 5,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1095.jpg",
						"Status": "Available",
						"Quantity": 12,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1096.jpg",
						"Status": "Available",
						"Quantity": 18,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1097.jpg",
						"Status": "Available",
						"Quantity": 21,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6123.jpg",
						"Status": "Available",
						"Quantity": 13,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6122.jpg",
						"Status": "Available",
						"Quantity": 23,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "ITelo Jog-Mate",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6121.jpg",
						"Status": "Available",
						"Quantity": 24,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6120.jpg",
						"Status": "Available",
						"Quantity": 15,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Record Movie",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6111.jpg",
						"Status": "Available",
						"Quantity": 24,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"Name": "Play Movie",
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6110.jpg",
						"Status": "Available",
						"Quantity": 15,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6102.jpg",
						"Status": "Available",
						"Quantity": 16,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6101.jpg",
						"Status": "Available",
						"Quantity": 18,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2002.jpg",
						"Status": "Available",
						"Quantity": 50,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-6100.jpg",
						"Status": "Available",
						"Quantity": 32,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2027.jpg",
						"Status": "Available",
						"Quantity": 25,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2026.jpg",
						"Status": "Available",
						"Quantity": 16,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2025.jpg",
						"Status": "Available",
						"Quantity": 26,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2001.jpg",
						"Status": "Available",
						"Quantity": 21,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-2000.jpg",
						"Status": "Available",
						"Quantity": 20,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1603.jpg",
						"Status": "Available",
						"Quantity": 25,
						"UoM": "PC",
						"CurrencyCode": "EUR",
						...
						"ProductPicUrl": "https://openui5.hana.ondemand.com/test-resources/sap/ui/documentation/sdk/images/HT-1600.jpg",
						"Status": "Available",
						"Quantity": 10,
						"UoM": "PC",
						"CurrencyCode": "EUR",
					...
					/*			this.model = this.getView().getModel();
								this.model.read("/ProductSet", {
									success: function (odata) {
										...
										var obj = groupBy(odata.results, "Category");
										this.getView().getModel("init_data").getData().product = "asd";
									}.bind(this),
									error: function () {
